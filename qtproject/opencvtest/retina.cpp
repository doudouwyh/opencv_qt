...
int retina_test()
{
    ...
    bool useLogSampling = false; // check if user wants retina log sampling processing

    //std::string inputMediaType="-image"; //"-video"
    std::string inputMediaType="-video"; //"-video"
    ...
    {
        std::cout<<"RetinaDemo: processing image "<<"./images/retina_TreeHdr_small.jpg"<<std::endl;
        // image processing case
        inputFrame = cv::imread(std::string("./images/retina_TreeHdr_small.jpg"), 1); // load image in RGB mode
    }else
        if (!strcmp(inputMediaType.c_str(), "-video"))
        {
            std::cout<<"RetinaDemo: processing video stream "<<"./images/tree.avi"<<std::endl;
            videoCapture.open("./images/tree.avi");
