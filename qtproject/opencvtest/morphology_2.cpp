...
const char* window_name2 = "Morphology Transformations Demo";
...
int morphology_2_test( )
{
  ...
  createTrackbar("Operator:\n 0: Opening - 1: Closing  \n 2: Gradient - 3: Top Hat \n 4: Black Hat", window_name2, &morph_operator, max_operator, Morphology_Operations );

  /// Create Trackbar to select kernel type
  createTrackbar( "Element:\n 0: Rect - 1: Cross - 2: Ellipse", window_name2,
                  &morph_elem, max_elem,
