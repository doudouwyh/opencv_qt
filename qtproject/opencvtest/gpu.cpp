...
double getPSNR_CPU(const Mat& I1, const Mat& I2);      // CPU versions
Scalar getMSSIM_CPU( const Mat& I1, const Mat& I2);
...
{
    help();
    Mat I1 = imread("./images/aloeL.jpg");
    Mat I2 = imread("./images/aloeR.jpg");
