...
//    if( argc > 2 )
//    {
//        images_folder = "./images/latent_svm/train";
//        models_folder = "./images/latent_svm/model";
...
//    }
    ...
    cout<<"images:"<<endl;
    std::copy(images_filenames.begin(), images_filenames.end(), std::ostream_iterator<string>(std::cout, " "));
    cout<<endl<<"models:"<<endl;
    std::copy(models_filenames.begin(), models_filenames.end(), std::ostream_iterator<string>(std::cout, " "));
    cout<<endl;
