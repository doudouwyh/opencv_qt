...
int descriptor_extractor_macher_test()
{
    ...
    string method = "SURF";
    string method2 = "SURF";
    string method3 = "FlannBased";
    string filtertype = "NoneFilter";
    Ptr<FeatureDetector> detector = FeatureDetector::create(method);
    Ptr<DescriptorExtractor> descriptorExtractor = DescriptorExtractor::create( method2);
    Ptr<DescriptorMatcher> descriptorMatcher = DescriptorMatcher::create(method3 );
    int mactherFilterType = getMatcherFilterType(filtertype );
    ...
    Mat img1 = imread("./images/lena.jpg"), img2;
    if( !isWarpPerspective )
        img2 = imread("./images/lena.jpg");
    cout << ">" << endl;
