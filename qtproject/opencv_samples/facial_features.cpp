...
//    setCommandOptions(args, argc, argv);
    ...
    input_image_path ="./images/lena.jpg";
    face_cascade_path = "./images/haarcascades/haarcascade_frontalface_alt2.xml";
    eye_cascade_path = "./images/haarcascades/haarcascade_eye.xml";
    nose_cascade_path = "./images/haarcascades/haarcascade_mcs_nose.xml";
    mouth_cascade_path = "./images/haarcascades/haarcascade_mcs_mouth.xml";
