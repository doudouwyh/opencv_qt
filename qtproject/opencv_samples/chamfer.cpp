...
//    string templ = parser.get<string>("2");
    string image = "./images/logo_in_clutter.png";
    string templ = "./images/logo.png";
    Mat img = imread(image.c_str(), 0);
    Mat tpl = imread(templ.c_str(), 0);

    Mat origintpl ;
    tpl.copyTo(origintpl);
    ...
    cout <<"after chamerMatching...."<<endl;
